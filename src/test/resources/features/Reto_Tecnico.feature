...
Feature: User Register
  ...
  Scenario: Register in the website
    Given than Miguel wants to register in Utest.com
      ...
      | Pruebaops    | Pruebas     | Pruebas81654@gmail.com | November | 18     | 1998    | Spanish     | Cali Valle de Cauca, Colombia | 760004     | Windows     | 10         | Spanish       | Apple     | IPhone   | iOS 2.0   | Prueba100*  | Prueba100*     |
